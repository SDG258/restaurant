...
if (isset($_POST['name'])) {
    ...
    if (!$errors) {
        $sql = "INSERT INTO product(name, price, sale, image, category_id, desciption, status) VALUE ('$name', '$price', '$sale', '$image', '$category_id', '$desciption', '$status')";
        if ($conn->query($sql)) {
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desciption" class="form-control desciption" rows="8" placeholder="Input desciption Product"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="sale" placeholder="Input Sale">
                                    </div>
                                    <div class="form-group">
